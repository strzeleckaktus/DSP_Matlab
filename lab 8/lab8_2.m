...
%gain = 0.0005;
%z = [1.5, 1.5,1.5 ,1.5 ] .* exp(j*2*pi*[ 100, 350, 650, 1000 ]/fs); z = [z conj(z)];
gain = 0.4;
z = [1, 1,1 ,1 ] .* exp(j*2*pi*[ 100, 350, 650, 1000 ]/fs); z = [z conj(z)];
p = [ 0.95, 0.95, 0.95, 0.95, 0.95 ] .* exp(j*2*pi*[ 400, 450, 500, 550, 600 ]/fs); p = [p conj(p)];
